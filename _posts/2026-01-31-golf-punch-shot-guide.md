...
1. **Setup creates trajectory**: Ball back, weight forward, grip down
2. **Shorter and smoother**: 50-75% backswing, 70% effort
3. **Low finish**: Abbreviated follow-through, hands stay low
4. **Safety first**: Find the biggest opening, manage expectations
5. **Practice before pressure**: Work on this shot every range session
