---
layout: post
title: "How to Hit a Draw in Golf: Complete Guide to the Right-to-Left Shot"
date: 2026-01-30
categories:
- golf
- instruction
description: "Learn how to hit a draw shot in golf with this step-by-step guide. Master grip, alignment, swing path, and clubface control for controlled right-to-left ball flight."
...
- inside out swing
seo:
  title: How to Hit a Draw in Golf - Complete Guide
  description: Master the draw shot with our complete guide. Learn grip, alignment, swing path, and clubface control for consistent right-to-left ball flight and extra distance.
---
...
1. **Clubface angle at impact** determines where the ball starts (roughly 75-85% of starting direction)
2. **Swing path relative to the face** determines how much it curves
...
1. **Lead hand (left for righties)**: Rotate it clockwise on the club until you can see 2.5-3 knuckles when looking down
2. **Trail hand (right for righties)**: Position it more underneath the club, with the V between thumb and forefinger pointing toward your trail shoulder
...
1. **Aim your clubface** at your target (or very slightly right of it)
2. **Align your feet, hips, and shoulders** to the right of target, along the line where you want the ball to start
3. **The gap between your body line and clubface aim** creates the inside-out path and closed-face relationship
...
1. **Strengthen your grip** slightly and hit some shots
2. **Adjust your alignment** with feet and shoulders right of target
3. **Work on the inside path** with drills before hitting full shots
4. **Check your progress with video** to verify feel matches reality
5. **Start with half swings** and build to full swings only when the shape is consistent
6. **Be patient** with the transition period where shots may go both directions
