...
**Positive attack angle:** The club is moving upward at impact (hitting up on the ball)
**Negative attack angle:** The club is moving downward at impact (hitting down on the ball)
...
### Driver
**Tour average:** +1 to +5 degrees (slightly up)
**Why:** Driver has the least loft, so hitting up adds launch without adding spin
...
### Fairway Woods
**Tour average:** -1 to -3 degrees (slightly down)
**Why:** Ball is on the ground, so you need a descending blow to compress it
...
### Wedges
**Tour average:** -4 to -6 degrees
**Why:** Wedge loft is already high, so a descending blow creates maximum spin without ballooning the shot.
