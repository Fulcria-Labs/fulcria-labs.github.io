...
**Test 1: The Finish Hold**
Make 5 swings with your 7-iron. Hold your finish until the ball lands. Score yourself:
- 5/5 holds = excellent balance
- 3-4/5 = needs work
- 0-2/5 = balance is a major issue

**Test 2: One-Legged Address**
Set up to the ball normally, then lift your trail foot off the ground. Can you maintain your posture for 10 seconds without wavering?

**Test 3: Eyes Closed Swing**
Make slow half-swings with your eyes closed. Do you feel stable, or do you start drifting immediately?
...
**Why it works:**
With no base to push against, you're forced to stay centered. Sway or slide and you'll fall over. Your body naturally learns efficient rotation.

**Progression:**
1. Start with half-swings until contact is consistent
2. Progress to three-quarter swings
3. Gradually increase speed while maintaining balance
...
2. On the downswing, step your trail foot toward the target
3. Finish with your trail foot next to your lead foot
4. Hold the finish with feet together

**Why it works:**
Forces commitment to the target. You can't hang back or fall backward when your momentum is carrying you forward.
...
2. At the top, lift your trail foot slightly off the ground
3. Complete the swing balanced on your lead leg
4. Hold the finish on one leg for 2-3 seconds

**Why it works:**
Eliminates hanging back and forces proper weight transfer. Tour pros like Dustin Johnson finish with almost no weight on their trail foot—this drill teaches that feeling.
...
**Progression:**
1. Practice without a ball until stable
2. Add ball contact at 30% speed
3. Gradually increase as balance improves
...
**Execution:**
1. Set up normally with eyes open
2. Close your eyes
3. Make a slow, controlled swing
4. Open eyes only after contact

**Why it works:**
Forces proprioceptive awareness. You'll feel exactly where you're unstable instead of using vision to compensate.
...
**Execution:**
1. Make a swing and freeze at the finish
2. Check these positions:
...
**Why it works:**
If you practice the end position, your body learns to sequence everything to get there. It's reverse engineering balance.
...
**Execution:**
1. Count "one... two... three" during your backswing
2. Count "one" during your downswing through impact
3. The slower backswing prevents rushing and jerky movements that destroy balance
...
[Upload a swing to Swing Analyzer](https://swing.fulcria.com) for instant feedback on your positions—including whether your finish shows good balance indicators.

## The 30-Day Balance Challenge

Week 1: Feet together drill only (15 minutes daily)
Week 2: Add step-through drill (15 minutes total)
Week 3: Add foam roller or eyes closed work (15 minutes total)
Week 4: Integration—normal swings with finish holds (15 minutes daily)
